...
export default ({user, updateField}) => {
   ...
   return (
      <div className="p-grid">
         ...
         <div className="p-col-9"><Checkbox checked={user.friendly} name="friendly" onChange={e => updateField(e)} /></div>
         ...
         <div className="p-col-9"><Checkbox checked={user.showwhenonline} name="showwhenonline" onChange={e => updateField(e)} /></div>
         <div className="p-col-3 text-right font-weight-bold">Receive inbox notifications as email?:</div>
         <div className="p-col-9"><Checkbox checked={user.notifyemail} name="notifyemail" onChange={e => updateField(e)} /></div>
         <div className="p-col-3 text-right font-weight-bold">Receive inbox notifications as SMS?:</div>
         <div className="p-col-9"><Checkbox checked={user.notifysms} name="notifysms" onChange={e => updateField(e)} /></div> 
      </div>
   );
